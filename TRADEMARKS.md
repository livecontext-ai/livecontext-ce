...
- State, truthfully, that your product is "built on LiveContext", "powered by
  LiveContext", or "compatible with LiveContext".
- Keep the LiveContext name and marks in unmodified copies you redistribute.
- Refer to the project by name in articles, talks, and documentation.

## Please do not, without written permission

- Use "LiveContext" (or a confusingly similar name) as the name of your own
  product, company, or hosted service.
- Use the LiveContext logo as the icon or branding of your fork or service.
- Present a modified version in a way that suggests it is the official
