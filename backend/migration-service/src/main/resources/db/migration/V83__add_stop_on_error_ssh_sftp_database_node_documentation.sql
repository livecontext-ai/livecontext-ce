-- ============================================================================
-- V83: Add node_type_documentation rows for 4 new nodes:
--   - core:stop_on_error - Immediately fail workflow with error message
--   - core:ssh - Execute commands on remote servers via SSH
--   - core:sftp - File operations on remote servers via SFTP
--   - core:database - Execute SQL queries against databases
-- ============================================================================
