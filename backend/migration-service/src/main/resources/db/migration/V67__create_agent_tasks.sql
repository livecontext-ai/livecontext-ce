-- ============================================================================
-- V67: Agent Task Delegation System
-- ============================================================================
-- Adds async task delegation between agents:
--   - agent_task_recurrences: cron-driven templates that emit tasks
--   - agent_tasks: delegated work items (assigned or backlog)
--   - agent_task_notes: free-form conversation on a task
--   - agent_task_events: audit trail (status transitions, reassignments, ...)
...
-- ---------------------------------------------------------------------------
-- Shedlock table for agent-service @Scheduled methods (recurrence scheduler).
-- V66 created shedlock tables in auth/conversation/publication schemas; agent
-- was missing one because it had no @Scheduled methods. Add it now that the
-- recurrence ticker needs distributed locking.
-- ---------------------------------------------------------------------------
