-- Re-insert SMTP credential template (originally V17, but wiped by catalog TRUNCATE during API re-imports)
-- ON CONFLICT DO NOTHING so it's safe to run repeatedly
