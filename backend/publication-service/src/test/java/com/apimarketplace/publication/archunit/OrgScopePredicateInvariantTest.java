package com.apimarketplace.publication.archunit;
...
/**
 * publication-service mirror of orchestrator's {@code OrgScopePredicateInvariantTest}.
 * Same rule logic, different classpath scan. See the reference implementation for
 * the contract + design rationale. WorkflowPublicationService and SharedLinkService
 * are heavy ScopeGuard consumers; this mirror keeps future predicates funneled
 * through it.
 */
@DisplayName("ScopeGuard callsite invariants (publication-service mirror)")
class OrgScopePredicateInvariantTest {
    ...
    private final JavaClasses classes = new ClassFileImporter()
            ...
            .importPackages("com.apimarketplace.publication");
    ...
    void rule1NoHandRolledScopePredicate() {
        ...
        assertThat(offenders)
                .as("publication-service: hand-rolled scope predicate detected.")
                .isEmpty();
    }
    ...
    void rule2TolerantCallSitesMustBeAnnotated() {
        ...
        assertThat(offenders)
                .as("publication-service: isInOwnerOrOrgScope without @TolerantScope.")
                .isEmpty();
    }
