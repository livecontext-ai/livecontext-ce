 ...
 */
@DisplayName("Agent GlobalExceptionHandler - real dispatch")
class GlobalExceptionHandlerDispatchTest {
    ...
    static class FixtureController {
        ...
        Map<String, Object> staticMiss() throws NoResourceFoundException {
            // What Spring's resource handler raises for api/agents/route-qui-nexiste-pas
            throw new NoResourceFoundException(HttpMethod.GET, "api/agents/route-qui-nexiste-pas");
        }
    ...
    @Test
    @DisplayName("NoResourceFoundException (GET /api/agents/<not a UUID>, no /{id} mapping matches) -> 404 NOT_FOUND from the advice, no ERROR")
