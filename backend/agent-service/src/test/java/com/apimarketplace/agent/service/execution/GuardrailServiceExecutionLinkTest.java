...
class GuardrailServiceExecutionLinkTest {
    ...
    void disabledModelRunsOnReplacementThroughItsLink() {
        ...
        // priced and executed (check still succeeds).
    ...
    @Test
    @DisplayName("a bridge-linked check is pinned PLATFORM without consulting the resolver (a bridge holds no API key)")
