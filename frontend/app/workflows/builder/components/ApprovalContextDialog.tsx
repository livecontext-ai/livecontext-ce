        ...
        <DialogContent className="max-w-xl">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-amber-200/70 dark:border-amber-500/30 bg-amber-50/60 dark:bg-amber-500/10 px-2.5 py-1.5">
              {total > 1 && (
                <button
                  ...
                  className="w-6 h-6 p-0 rounded-lg inline-flex items-center justify-center text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-500/20 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                >
              ...
              <span className="flex items-center gap-1.5 min-w-0">
                ...
                {current.epoch != null && (
                  <span
                    ...
                    className="text-xs px-1.5 rounded-md bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-300 whitespace-nowrap"
                  >
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-500/20 dark:text-emerald-300 dark:hover:bg-emerald-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
            >
            ...
            <button
              ...
              disabled={resolving != null}
              className="flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-500/20 dark:text-red-300 dark:hover:bg-red-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
            >
