...
import { Copy, Check, AlertCircle, Eye, EyeOff, ExternalLink } from 'lucide-react';
...
const WebhookInfoTooltip = ({ title, description, outputsLabel, outputs }: WebhookInfoTooltipProps) => {
  return (
    <InfoPopover label={title} size="sm" side="bottom" align="end" contentClassName="w-[288px] p-3">
